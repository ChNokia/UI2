...
public class ListFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    String[] category = { "Політика", "Неймовірне", "Калейдоскоп", "Економіка", "Спорт",
                          "Життя", "Калейдоскоп", "Економіка", "Спорт", "Політика",
                          "Неймовірне", "Калейдоскоп", "Економіка", "Спорт", "Життя",
                          "Економіка", "Спорт", "Політика", "Неймовірне", "Калейдоскоп"};

    String[] titles = { "В Раду проходять партії Порошенка, Ляшка і Тимошенко",
                         "\"Курс молодого бійця\" можуть зробити обов'язковим для всіх",
                         "Кинопремьеры недели: Владимир П… должен умереть",
                         "Співочий друг Ющенка-молодшого отримав посаду у Київраді",
                         "Яценюк заощаджує на перельоті, але тринькає гроші на готелі?",
                         "Кака може повернутися в збірну Бразилії", "Marca: Ройс погодився перейти в Реал",
                         "Китай. Світоліна не змогла пробитися у фінал", "Гладир відновився від травми",
                         "Маркевич: Думками ми вже у Франції", "Охранник", "Директор", "Программер", "Охранник",
                         "Директор", "Программер", "Охранник", "Директор", "Программер", "Охранник"};

    void fillData() {
        for (int i = 0; i < category.length; i++) {
            newsList.add(new ItemNews(category[i], titles[i],images[i]));
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View listRoot = inflater.inflate(R.layout.fragment_list, null);
